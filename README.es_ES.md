...
[![](https://img.shields.io/github/v/release/utpinfo/3x-ui.svg)](https://github.com/utpinfo/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/utpinfo/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/utpinfo/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/utpinfo/3x-ui/total.svg)](#)
...
<p align="left"><a href="#"><img width="125" src="https://github.com/utpinfo/3x-ui/assets/115543613/7aa895dd-048a-42e7-989b-afd41a74e2e1" alt="Image"></a></p>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/utpinfo/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/utpinfo/3x-ui/master/install.sh) v2.2.8
```
...
wget https://github.com/utpinfo/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clona el Repositorio del Proyecto:
   ...
   ```sh
   git clone https://github.com/utpinfo/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/utpinfo/3x-ui.svg)](https://starchart.cc/utpinfo/3x-ui)
